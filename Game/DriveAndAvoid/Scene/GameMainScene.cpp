...
void GameMainScene::Draw() const
{
	...
	float fx = 510.0f;
	float fy = 380.0f;
	DrawFormatString(fx, fy, GetColor(0, 0, 0), "燃料ゲージ");
	...
	fx = 510.0f;
	fy = 430.0f;
	DrawFormatString(fx, fy, GetColor(0, 0, 0), "残りHP");
	DrawBoxAA(fx, fy + 20.0f, fx + (player->GetHp() * 1000 / 1000), fy + 40.0f,
...
void GameMainScene::Finalize()
{
	...
	if (result != 0)
	{
		throw ("Resource/dat/rwsult_data.csvが開けません\n");
	}
